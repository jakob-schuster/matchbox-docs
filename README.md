...
1. **MAJOR** version bump when you make a site overhaul (e.g. move from Zola to Quarto) or significantly restructure the site
...
3. **PATCH** version bump when you make an edit that's strictly additive and does not change the meaning of existing text (e.g. you add a new example, or document a new function). Additionally, fixing graphical or technical issues constitute a patch version bump.
